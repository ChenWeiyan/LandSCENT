#' @title 
#' Computes the local signaling entropy
#' 
#' @aliases CompS
#'  
#' @description 
#' Computes the local signaling entropy for a gene. This is an internal 
#' function which the user does not need to invoke.
#' 
#' @param p.v
...
#' 
#' @return LS
#' A value indicates the local entropy.
#' 
