...
LandSR.o <- Plot_LandSR(potencyInfer.o, reducedMatrix = tsne.o, 
                        reduceDim = FALSE, colpersp = NULL, 
                        colimage = NULL, bty = "f", PDF = FALSE)
```

The output list *LandSR.o* will store the tSNE cluster result. you can easily access it with
...
CellSR.o <- Plot_CellSR(potencyInfer.o, reducedMatrix = tsne.o, 
                        reduceDim = FALSE, num_grid = 35, theta = 40, 
                        colpersp = NULL, colimage = NULL, bty = "f", PDF = FALSE)
```

The output list *CellSR.o* will also store the tSNE cluster result, in *CellSR.o$tSNE.m*.
...
DoLandSCENT.o <- DoLandSCENT(exp.m = Example.m, ppiA.m = net13Jun12.m,
                             ...
                             reducedMatrix = NULL, reduceDim = TRUE, 
